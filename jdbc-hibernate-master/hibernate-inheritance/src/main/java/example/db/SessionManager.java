...
import example.inheritance.singletable.AbstractBooking;
    ...
    private static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                configuration.addAnnotatedClass(AbstractBooking.class);
                configuration.addAnnotatedClass(RestaurantBooking.class);
